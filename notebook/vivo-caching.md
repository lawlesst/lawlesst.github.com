...
This caching configuration will only be used for users that are not logged in.  Requests initiated by logged in users will be generated dynamically as normal.  
